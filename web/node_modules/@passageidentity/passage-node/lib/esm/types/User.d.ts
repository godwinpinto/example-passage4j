...
export declare type UserStatusEnum = keyof typeof UserStatus;
export interface PossibleUserUpdateAttributes {
    email: string;
    phone: string;
}
export declare type UserAttributes = Pick<PossibleUserUpdateAttributes, 'email'> | Pick<PossibleUserUpdateAttributes, 'phone'>;
