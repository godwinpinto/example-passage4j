...
class Passage {
    ...
    constructor(config) {
        ...
        if (!(config === null || config === void 0 ? void 0 : config.appID)) {
            throw new PassageError_1.PassageError('A Passage appID is required. Please include {appID: YOUR_APP_ID}.');
        }
        this.appID = config.appID;
        __classPrivateFieldSet(this, _Passage_apiKey, config === null || config === void 0 ? void 0 : config.apiKey, "f");
        this.user = new User_1.default(config);
        this.authStrategy = (config === null || config === void 0 ? void 0 : config.authStrategy) ? config.authStrategy : 'COOKIE';
        this.jwks = (0, jose_1.createRemoteJWKSet)(new URL(`https://auth.passage.id/v1/apps/${this.appID}/.well-known/jwks.json`), {
    ...
    authenticateRequestWithHeader(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!authorization) {
                throw new PassageError_1.PassageError('Header authorization not found. You must catch this error.');
            }
            else {
    ...
    authenticateRequestWithCookie(req) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!cookiesStr) {
                throw new PassageError_1.PassageError('Could not find valid cookie for authentication. You must catch this error.');
            }
            ...
            if (passageAuthToken) {
                ...
                if (userID)
                    ...
                    throw new PassageError_1.PassageError('Could not validate auth token. You must catch this error.');
                }
            }
            else {
                throw new PassageError_1.PassageError("Could not find authentication cookie 'psg_auth_token' token. You must catch this error.");
            }
        });
    }
    /**
    ...
    validAuthToken(token) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { kid } = (0, jose_1.decodeProtectedHeader)(token);
                if (!kid) {
                    return undefined;
                }
                const { payload: { sub: userID }, } = yield (0, jose_1.jwtVerify)(token, this.jwks);
                if (userID)
    ...
    createMagicLink(magicLinkReq) {
        return __awaiter(this, void 0, void 0, function* () {
            const magicLinkData = yield axios_1.default
                ...
                .catch((err) => {
                throw new PassageError_1.PassageError('Could not create a magic link for this app.', err);
            })
                .then((res) => {
    ...
    getApp() {
        return __awaiter(this, void 0, void 0, function* () {
            const appData = yield axios_1.default
                .get(`https://api.passage.id/v1/apps/${this.appID}`)
                .catch((err) => {
                throw new PassageError_1.PassageError('Could not fetch app.', err);
            })
                .then((res) => {
                return res.data.app;
            });
