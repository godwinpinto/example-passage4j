...
declare class User {
    ...
    /**
     * _getAuthToken gets the current authToken for the currently authenticated user.
     * @return {string} returns the user's authToken if it exists in localstorage, empty string if not.
     */
...
declare class Passage {
    ...
    /**
     * Set the auth token in localStorage with the key psg_auth_token
     * @param {string} authToken
     */
    setAuthToken(authToken: string): void;
    /**
     * Sign out a user by removing their JWT from local storage.
     */
    signOut(): void;
    /**
     ...
     * @param {string} [authToken] optional param to supply the authToken (JWT) of the current user
     * @return {User} the Passage User
     */
    getCurrentUser(authToken?: string): User;
    /**
...
export { BrowserInfo, CreateUserPayload, Identifier, Metadata, Passage, PassageAppInfo, PassageDevice, PassageEditDeviceRequest, PassageError, PassageErrorCode, PassageMagicLinkRequest, PassageUser, PassageUserInfo, PassageUserStatus, RequiredIdentifier, User, UserMetadataLayout, UserMetadataSchema, UserMetadataType, WebAuthnType, authResult };
