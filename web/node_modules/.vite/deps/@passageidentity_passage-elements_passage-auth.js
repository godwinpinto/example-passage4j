...
var s = (i, e2, t2) => new Promise((r2, a2) => {
  var o2 = (l) => {
    try {
      d(t2.next(l));
    } catch (p2) {
  ...
  }, d = (l) => l.done ? r2(l.value) : Promise.resolve(l.value).then(o2, m2);
  d((t2 = t2.apply(i, e2)).next());
});
var g$1 = (i, e2) => s(void 0, null, function* () {
  let t2, r2 = new Promise((a2) => {
    t2 = setTimeout(a2, e2);
  });
  return Promise.race([i, r2]).then((a2) => (clearTimeout(t2), a2));
});
var n$1 = class {
  ...
  static decodeBytes(e2) {
    let t2 = e2.replace(/-/g, "+").replace(/_/g, "/"), r2 = C$1(t2);
    return Uint8Array.from(atob(r2), (o2) => o2.charCodeAt(0));
  }
};
var C$1 = (i) => {
  let e2 = i.indexOf("=");
  return i.slice(0, e2 === -1 ? i.length : e2);
};
var u = class {
  static createCredentialAvailable() {
    return s(this, null, function* () {
      let e2 = { securityKey: false, platform: false, isAvailable: false };
      return window.PublicKeyCredential && (e2.securityKey = true, e2.isAvailable = true, yield g$1(window.PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable().then((t2) => {
        e2.platform = t2;
  ...
  static createCredential(e2) {
    return s(this, null, function* () {
      let t2 = { credential: null, transports: [] }, r2 = this.parsePublicKey(e2), a2 = yield navigator.credentials.create({ publicKey: r2 }).then((o2) => o2);
      return a2 == null || (t2.credential = a2, t2.transports = this.getTransports(a2)), t2;
    });
  }
};
var c = class {
  ...
  getCrossDeviceCredential() {
    return this.userAgent.getOS().name === "Android" ? false : this.getSyncedCredential();
  }
...
var y$1 = class {
  ...
  static getCredential(e2, t2) {
    return s(this, null, function* () {
      return yield navigator.credentials.get({ mediation: t2 == null ? void 0 : t2.mediation, signal: t2 == null ? void 0 : t2.signal, publicKey: this.parsePublicKey(e2) }).then((a2) => a2);
    });
  }
  static getCredentialAvailable() {
    return s(this, null, function* () {
      let e2 = { securityKey: false, platform: false, syncedCredential: false, crossDeviceCredential: false, conditionalUI: false, isAvailable: false }, t2 = yield u.createCredentialAvailable();
...
var g = class {
  ...
  decodeBytes(e2) {
    let t2 = e2.replace(/-/g, "+").replace(/_/g, "/"), n2 = W(t2);
...
var f = class {
  ...
  setPsgCredID(e2, t2) {
    ...
    if (n2) {
      let s2 = JSON.parse(n2);
      s2[e2] = t2 == null ? void 0 : t2.id, this.setPsgCredObj(JSON.stringify(s2));
    } else
  ...
  removeCredential(e2) {
    ...
    Object.keys(n2).forEach((s2) => {
      n2[s2] === e2 && delete n2[s2];
...
function a(r2) {
  return __async(this, null, function* () {
    return r2.ok ? r2.json() : yield r2.text().then((e2) => {
      throw new h(e2, r2);
    });
  });
}
function D() {
  let r2 = navigator.userAgent.toLowerCase().indexOf("firefox") > -1, e2 = window.navigator.userAgent.match(/Firefox\/([0-9]+)\./), t2 = e2 ? parseInt(e2[1]) : 0;
  return navigator.platform.indexOf("Win") !== -1 && r2 && t2 === 98;
}
function J(r2) {
  let e2 = new Uint8Array(68);
  e2.set(r2.slice(0, 68));
  let t2 = new Uint8Array(r2.byteLength - 68);
  t2.set(r2.slice(68, r2.byteLength));
  let n2 = new Uint8Array(15), s2 = new Uint8Array(e2.byteLength + n2.byteLength + t2.byteLength);
  s2.set(e2, 0), s2.set(n2, e2.byteLength), s2.set(t2, e2.byteLength + n2.byteLength);
  let p2 = s2[30] + 15;
  return s2.set([p2], 30), s2;
}
var K = { URL: "https://auth.passage.id", version: "@passageidentity/passage-js 3.6.4", CAPTURE_EVENT_URL: "https://us-central1-passage-prod.cloudfunctions.net/capture-event", SENTRY_RELEASE: "passage-js@3.6.4-prod", SENTRY_PROJECT: "passage-js", SENTRY_PROJECT_DSN: "", SENTRY_PROJECT_ENV: "prod", SENTRY_PROJECT_VERSION: "3.6.4" };
var y = K;
function o(r2) {
  let e2 = new Headers(r2), t2 = y.version;
  return e2.append("Passage-Version", t2), e2;
}
var q = class {
  getRefreshToken() {
...
function _(r2) {
  return r2.setTokens !== void 0;
}
var Q = (r2) => typeof r2 == "object" && r2 !== null && typeof r2.auth_result < "u";
function w(r2, e2) {
  return Q(r2) ? (_(e2) && e2.setTokens(r2.auth_result), r2) : (console.warn("Not a valid auth response"), r2);
}
var G = new g();
var Z = new f();
var A = class {
  ...
  withWebAuthn() {
    return __async(this, null, function* () {
      let e2 = yield fetch(this.apiUrl + "webauthn/start", { headers: o(), body: JSON.stringify({ identifier: this.identifier }), method: "POST" }).then(a), t2 = e2.handshake.challenge.publicKey, { credential: n2, transports: s2 } = yield u.createCredential(t2).catch((b) => {
        throw new h("error parsing public key for webAuthn", { status: 702, statusText: "PSG Parse Public Key For Login Failed" });
      }), p2 = new Uint8Array(n2 == null ? void 0 : n2.response.attestationObject);
      D() && (p2 = J(p2));
      let c2 = e2.user.id, d = yield fetch(this.apiUrl + "webauthn/finish", { headers: o(), method: "POST", body: JSON.stringify({ user_id: c2, handshake_id: e2.handshake.id, handshake_response: { rawId: G.encodeBytes(n2 == null ? void 0 : n2.rawId), id: n2 == null ? void 0 : n2.id, type: n2 == null ? void 0 : n2.type, response: { attestationObject: G.encodeBytes(p2), clientDataJSON: G.encodeBytes(n2 == null ? void 0 : n2.response.clientDataJSON) }, transports: s2 } }) }).then(a).then((b) => w(b, this.tokenStore));
      return Z.setPsgCredID(c2, n2), d.auth_result;
    });
  }
};
var L = new g();
var R = class {
  ...
  withWebAuthn(e2) {
    return __async(this, null, function* () {
      let t2 = JSON.stringify({ identifier: this.identifier }), n2 = this.identifier ? t2 : void 0, s2 = yield fetch(this.apiUrl + "webauthn/start", { headers: o(), method: "POST", body: n2 }).then(a), p2 = s2.handshake.challenge.publicKey, c2 = yield y$1.getCredential(p2, e2).catch((b) => {
        throw new h("error parsing public key for webAuthn", { status: 702, statusText: "PSG Parse Public Key For Login Failed" });
      });
      return c2 ? (yield fetch(this.apiUrl + "webauthn/finish", { headers: o(), method: "POST", body: JSON.stringify({ user_id: this.identifier ? s2.user.id : void 0, handshake_id: s2.handshake.id, handshake_response: { id: c2.id, rawId: L.encodeBytes(c2.rawId), type: c2.type, response: { clientDataJSON: L.encodeBytes(c2.response.clientDataJSON), authenticatorData: L.encodeBytes(c2.response.authenticatorData), signature: L.encodeBytes(c2.response.signature), userHandle: L.encodeBytes(c2.response.userHandle) } } }) }).then(a).then((b) => w(b, this.tokenStore))).auth_result : { auth_token: "", redirect_url: "" };
    });
  }
};
var v = class {
  ...
  appInfo() {
    return __async(this, null, function* () {
      return (yield fetch(this.apiUrl, { headers: o(), method: "GET" }).then(a)).app;
    });
  }
  identifierExists(e2) {
    return __async(this, null, function* () {
      return (yield fetch(this.apiUrl + "/users?identifier=" + encodeURIComponent(e2), { headers: o(), method: "GET" }).then(a)).user;
    });
  }
};
var m = new g();
...
var k = class {
  ...
  newRegister(e2, t2) {
    return __async(this, null, function* () {
      return (yield fetch(this.apiUrl + "/register/magic-link", { headers: o(), method: "POST", body: JSON.stringify({ identifier: e2, magic_link_path: window.location.pathname + window.location.search + window.location.hash, language: t2 }) }).then(a)).magic_link;
    });
  }
  newLogin(e2, t2) {
    return __async(this, null, function* () {
      return (yield fetch(this.apiUrl + "/login/magic-link", { headers: o(), method: "POST", body: JSON.stringify({ identifier: e2, magic_link_path: window.location.pathname + window.location.search + window.location.hash, language: t2 }) }).then(a)).magic_link;
    });
  }
  getStatus(e2) {
    return __async(this, null, function* () {
      return (yield fetch(this.apiUrl + "/magic-link/status", { headers: o(), method: "POST", body: JSON.stringify({ id: e2 }) }).then(a).then((n2) => w(n2, this.tokenStore))).auth_result;
    });
  }
  activate(e2) {
    return __async(this, null, function* () {
      return (yield fetch(this.apiUrl + "/magic-link/activate", { headers: o(), method: "PATCH", body: JSON.stringify({ magic_link: e2 }) }).then(a).then((n2) => w(n2, this.tokenStore))).auth_result;
    });
  }
  activateWebAuthnLogin(e2) {
    return __async(this, null, function* () {
      let t2 = yield fetch(this.apiUrl + "/magic-link/webauthn/login/start", { headers: o(), body: JSON.stringify({ magic_link: e2 }), method: "POST" }).then(a);
      if (!(yield $.psgCredIDExists(t2)))
        throw new h("psg_cred_obj does not exist in the allow list", { status: 700, statusText: "Not Found" });
      let s2 = yield navigator.credentials.get({ publicKey: this._parsePublicKeyLogin(t2.handshake.challenge.publicKey) }).catch((c2) => {
        throw new h("could not parse publickey for login", { status: 702, statusText: "PSG Parse Public Key For Login Failed" });
      });
      return s2 ? (yield fetch(this.apiUrl + "/magic-link/webauthn/login/finish", { headers: o(), method: "POST", body: JSON.stringify({ magic_link: e2, user_id: t2.user.id, handshake_id: t2.handshake.id, handshake_response: { id: s2.id, rawId: m.encodeBytes(s2.rawId), type: s2.type, response: { clientDataJSON: m.encodeBytes(s2.response.clientDataJSON), authenticatorData: m.encodeBytes(s2.response.authenticatorData), signature: m.encodeBytes(s2.response.signature), userHandle: m.encodeBytes(s2.response.userHandle) } } }) }).then(a).then((c2) => w(c2, this.tokenStore))).auth_result : { auth_token: "", redirect_url: "" };
    });
  }
  activateWebAuthnNewDevice(e2) {
    return __async(this, null, function* () {
      let t2 = yield fetch(this.apiUrl + "/magic-link/webauthn/new/start", { headers: o(), body: JSON.stringify({ magic_link: e2 }), method: "POST" }).then(a), n2 = yield navigator.credentials.create({ publicKey: this._parsePublicKeyNewDevice(t2.handshake.challenge.publicKey) }).catch((d) => {
        throw new h("could not parse public key for new device", { status: 701, statusText: "PSG Parse Public Key For New Device Failed" });
      }), s2 = new Uint8Array(n2 == null ? void 0 : n2.response.attestationObject);
      D() && (s2 = J(s2));
      let p2 = yield fetch(this.apiUrl + "/magic-link/webauthn/new/finish", { headers: o(), method: "POST", body: JSON.stringify({ magic_link: e2, user_id: t2.user.id, handshake_id: t2.handshake.id, handshake_response: { rawId: m.encodeBytes(n2.rawId), id: n2.id, type: n2.type, response: { attestationObject: m.encodeBytes(s2), clientDataJSON: m.encodeBytes(n2.response.clientDataJSON) } }, device_name: navigator.userAgent }) }).then(a).then((d) => w(d, this.tokenStore)), c2 = t2.user.id;
      return $.setPsgCredID(c2, n2), p2.auth_result;
    });
  }
  _parsePublicKeyLogin(e2) {
    if (e2.challenge = m.decodeBytes(e2.challenge.toString()), e2.allowCredentials) {
      for (let t2 = 0; t2 < e2.allowCredentials.length; t2++) {
        let n2 = e2.allowCredentials[t2];
        n2.id = m.decodeBytes(n2.id.toString());
      }
      return e2;
    }
    return e2;
  ...
  _parsePublicKeyNewDevice(e2) {
    return e2.challenge = m.decodeBytes(e2.challenge.toString()), e2.user.id = m.decodeBytes(e2.user.id.toString()), e2;
  }
};
var P = class {
  constructor(e2, t2) {
  ...
  newRegister(e2, t2) {
    return __async(this, null, function* () {
      return yield fetch(this.apiUrl + "/register/otp", { headers: o(), method: "POST", body: JSON.stringify({ identifier: e2, language: t2 }) }).then(a);
    });
  }
  newLogin(e2, t2) {
    return __async(this, null, function* () {
      return yield fetch(this.apiUrl + "/login/otp", { headers: o(), method: "POST", body: JSON.stringify({ identifier: e2, language: t2 }) }).then(a);
    });
  }
  activate(e2, t2) {
    return __async(this, null, function* () {
      return (yield fetch(this.apiUrl + "/otp/activate", { headers: o(), method: "POST", body: JSON.stringify({ otp: e2, otp_id: t2 }) }).then(a).then((s2) => w(s2, this.tokenStore))).auth_result;
    });
  }
};
var te = ((n2) => (n2.ACTIVE = "active", n2.INACTIVE = "inactive", n2.PENDING = "pending", n2))(te || {});
var E = ((t2) => (t2.Platform = "platform", t2.Passkey = "passkey", t2))(E || {});
function O(r2) {
  return `${y.URL}/v1/apps/${r2}`;
}
var x = class {
  constructor(e2, t2) {
    this.tokenStore = t2;
    this.apiUrl = O(e2) + "/tokens/";
  }
  authGuard() {
    return __async(this, null, function* () {
      try {
  ...
  signOut() {
    return __async(this, null, function* () {
      ...
      return e2 ? fetch(`${this.apiUrl}?` + new URLSearchParams({ refresh_token: e2 }), { method: "DELETE" }).then(({ status: t2 }) => t2 === 200).finally(() => {
        _(this.tokenStore) && this.tokenStore.clearTokens();
      }) : (_(this.tokenStore) && this.tokenStore.clearTokens(), true);
    });
  }
  getAuthToken() {
    return __async(this, null, function* () {
  ...
  refresh() {
    return __async(this, null, function* () {
      ...
      return t2 ? fetch(this.apiUrl, { headers: o(), method: "POST", body: JSON.stringify({ refresh_token: t2 }) }).then(a).then((n2) => (_(this.tokenStore) && this.tokenStore.setTokens(n2.auth_result), n2.auth_result)).catch(() => {
        throw e2;
      }) : Promise.reject(e2);
    });
  }
...
var C = class {
  constructor(e2, t2) {
    this.tokenStore = t2;
    this.apiUrl = O(e2) + "/currentuser", this.session = new x(e2, this.tokenStore);
  }
  userInfo() {
    return __async(this, null, function* () {
  ...
  changeEmail(e2, t2) {
    return __async(this, null, function* () {
      ...
      return (yield fetch(`${this.apiUrl}/email`, { method: "PATCH", headers: o({ Authorization: `Bearer ${n2}`, "Content-Type": "application/json" }), body: JSON.stringify({ new_email: e2, language: t2 }) }).then(a)).magic_link;
    });
  }
  changePhone(e2, t2) {
    return __async(this, null, function* () {
      let n2 = yield this._getToken();
      return (yield fetch(`${this.apiUrl}/phone`, { method: "PATCH", headers: o({ Authorization: `Bearer ${n2}`, "Content-Type": "application/json" }), body: JSON.stringify({ new_phone: e2, language: t2 }) }).then(a)).magic_link;
    });
  }
  editDevice(e2, t2) {
    return __async(this, null, function* () {
      ...
      let n2 = yield this._getToken();
      return (yield fetch(`${this.apiUrl}/devices/${e2}`, { method: "PATCH", headers: o({ Authorization: `Bearer ${n2}`, "Content-Type": "application/json" }), body: JSON.stringify(__spreadValues({}, t2)) }).then(a)).device;
    });
  }
  listDevices() {
    return __async(this, null, function* () {
      let e2 = yield this._getToken();
      return (yield fetch(`${this.apiUrl}/devices/`, { method: "GET", headers: o({ Authorization: `Bearer ${e2}`, "Content-Type": "application/json" }) }).then(a)).devices;
    });
  }
  addDevice() {
    return __async(this, null, function* () {
      let e2 = yield this._getToken(), t2 = yield fetch(this.apiUrl + "/devices/start", { headers: o({ Authorization: `Bearer ${e2}` }), method: "POST" }).then(a), n2 = yield navigator.credentials.create({ publicKey: this._parsePublicKey(t2.handshake.challenge.publicKey) }).catch((d) => {
        throw new h("failed to parse public key", { status: 701, statusText: "PSG Parse Public Key For New Device Failed" });
      }).then((d) => d), s2 = [];
      (n2 == null ? void 0 : n2.response.getTransports) && typeof (n2 == null ? void 0 : n2.response.getTransports) == "function" && (s2 = n2 == null ? void 0 : n2.response.getTransports());
      let p2 = t2.user.id, c2 = yield fetch(this.apiUrl + "/devices/finish", { headers: o({ Authorization: `Bearer ${e2}` }), method: "POST", body: JSON.stringify({ user_id: p2, handshake_id: t2.handshake.id, handshake_response: { rawId: N.encodeBytes(n2 == null ? void 0 : n2.rawId), id: n2 == null ? void 0 : n2.id, type: n2 == null ? void 0 : n2.type, response: { attestationObject: N.encodeBytes(n2 == null ? void 0 : n2.response.attestationObject), clientDataJSON: N.encodeBytes(n2 == null ? void 0 : n2.response.clientDataJSON) }, transports: s2 } }) }).then(a);
      return z.setPsgCredID(p2, n2), c2.device;
    });
  }
  deleteDevice(e2) {
    return __async(this, null, function* () {
      ...
      let s2 = false, p2 = yield this._getToken();
      return s2 = yield fetch(`${this.apiUrl}/devices/${t2}`, { method: "DELETE", headers: o({ Authorization: `Bearer ${p2}`, "Content-Type": "application/json" }) }).then((c2) => __async(this, null, function* () {
        return c2.ok ? true : yield c2.text().then((d) => {
          throw new h(d, c2);
        });
      })), s2 && n2 !== void 0 && z.removeCredential(n2), s2;
    });
  }
  getMetadata() {
    return __async(this, null, function* () {
      let e2 = yield this._getToken();
      return (yield fetch(`${this.apiUrl}/user-metadata`, { method: "GET", headers: o({ Authorization: `Bearer ${e2}` }) }).then(a)).user_metadata;
    });
  }
  updateMetadata(e2) {
    return __async(this, null, function* () {
      let t2 = yield this._getToken();
      return (yield fetch(`${this.apiUrl}/user-metadata`, { method: "PATCH", headers: o({ Authorization: `Bearer ${t2}`, "Content-Type": "application/json" }), body: JSON.stringify({ user_metadata: e2 }) }).then(a)).user;
    });
  }
  _parsePublicKey(e2) {
    return e2.challenge = N.decodeBytes(e2.challenge.toString()), e2.user.id = N.decodeBytes(e2.user.id.toString()), e2;
  }
  _getToken() {
    return __async(this, null, function* () {
...
var I = class {
  getBrowserInfo() {
    return __async(this, null, function* () {
      let e2 = yield y$1.getCredentialAvailable();
...
var Y = class {
  constructor(e2, t2) {
    this.appID = e2;
    this.fullUrl = O(this.appID), (t2 == null ? void 0 : t2.tokenStore) === void 0 ? this.tokenStore = new F() : this.tokenStore = t2.tokenStore;
  }
  credIDExists(e2) {
    let t2 = new f().getPsgCredObj();
    return t2 ? !!JSON.parse(t2)[e2] : false;
  }
  register(e2) {
    return __async(this, null, function* () {
      return yield new A(this.fullUrl, this.tokenStore, e2).withWebAuthn();
    });
  }
  login(e2) {
    return __async(this, null, function* () {
      return yield new R(this.fullUrl, this.tokenStore, e2).withWebAuthn();
    });
  }
  loginConditional(e2) {
    return __async(this, null, function* () {
      return yield new R(this.fullUrl, this.tokenStore).withWebAuthn({ mediation: "conditional", signal: e2 });
    });
  }
  appInfo() {
    return __async(this, null, function* () {
  ...
  browserInfo() {
    return __async(this, null, function* () {
      return yield new I().getBrowserInfo();
    });
  }
  getCredentialAvailable() {
    return __async(this, null, function* () {
      return yield y$1.getCredentialAvailable();
    });
  }
  createCredentialAvailable() {
    return __async(this, null, function* () {
      return yield u.createCredentialAvailable();
    });
  }
  ...
  isWebauthnSupported(e2) {
    return __async(this, null, function* () {
      let t2 = yield u.createCredentialAvailable();
      return e2 ? t2.securityKey : t2.platform;
    });
  }
  identifierExists(e2) {
    return __async(this, null, function* () {
      let n2 = yield new v(this.fullUrl).identifierExists(e2);
      return n2 && (n2.hasPasskey = n2.webauthn_types.includes("passkey"), n2);
    });
  }
  newRegisterMagicLink(e2, t2) {
    return __async(this, null, function* () {
      return yield new k(this.fullUrl, this.tokenStore).newRegister(e2, t2);
    });
  }
  newLoginMagicLink(e2, t2) {
    return __async(this, null, function* () {
      return yield new k(this.fullUrl, this.tokenStore).newLogin(e2, t2);
    });
  }
  magicLinkActivate(e2) {
    return __async(this, null, function* () {
      return yield new k(this.fullUrl, this.tokenStore).activate(e2);
    });
  }
  magicLinkActivateWebAuthnLogin(e2) {
    return __async(this, null, function* () {
      return yield new k(this.fullUrl, this.tokenStore).activateWebAuthnLogin(e2);
    });
  }
  magicLinkActivateWebAuthnNewDevice(e2) {
    return __async(this, null, function* () {
      return yield new k(this.fullUrl, this.tokenStore).activateWebAuthnNewDevice(e2);
    });
  }
  getMagicLinkStatus(e2) {
    return __async(this, null, function* () {
      return yield new k(this.fullUrl, this.tokenStore).getStatus(e2);
    });
  }
  newRegisterOneTimePasscode(e2, t2) {
    return __async(this, null, function* () {
      return yield new P(this.fullUrl, this.tokenStore).newRegister(e2, t2);
    });
  }
  newLoginOneTimePasscode(e2, t2) {
    return __async(this, null, function* () {
      return yield new P(this.fullUrl, this.tokenStore).newLogin(e2, t2);
    });
  }
  oneTimePasscodeActivate(e2, t2) {
    return __async(this, null, function* () {
      return yield new P(this.fullUrl, this.tokenStore).activate(e2, t2);
    });
  }
  getCurrentUser() {
    return new C(this.appID, this.tokenStore);
  }
  getCurrentSession() {
    return new x(this.appID, this.tokenStore);
  }
  createUser(e2) {
    return __async(this, null, function* () {
      return (yield fetch(`${this.fullUrl}/users`, { headers: o(), body: JSON.stringify(__spreadValues({}, e2)), method: "POST" }).then(a)).user;
    });
  }
};
var oe = ((n2) => (n2.email = "email", n2.phone = "phone", n2.both = "both", n2))(oe || {});
var ae = ((s2) => (s2.Phone = "phone", s2.Email = "email", s2.Both = "both", s2.Either = "either", s2))(ae || {});
var ce = ((c2) => (c2.STRING = "string", c2.BOOLEAN = "boolean", c2.INTEGER = "integer", c2.DATE = "date", c2.PHONE = "phone", c2.EMAIL = "email", c2))(ce || {});
var ue = ((n2) => (n2.LoginCode = "otp", n2.MagicLink = "magic_link", n2.None = "none", n2))(ue || {});
...
var appId = ref("");
var appIdUnassigned = computed(() => isStringNullish(appId.value));
...
(function(module, exports) {
  !function(t2, e2) {
    ...
    var t2 = 1e3, e2 = 6e4, n2 = 36e5, r2 = "millisecond", i = "second", s2 = "minute", u2 = "hour", a2 = "day", o2 = "week", f2 = "month", h2 = "quarter", c2 = "year", d = "date", l = "Invalid Date", $2 = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y2 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t3) {
      ...
      return { M: f2, y: c2, w: o2, d: a2, D: d, h: u2, m: s2, s: i, ms: r2, Q: h2 }[t3] || String(t3 || "").toLowerCase().replace(/s$/, "");
    }, u: function(t3) {
      return void 0 === t3;
    } }, g2 = "en", D2 = {};
    D2[g2] = M;
    ...
    O2.l = S, O2.i = p2, O2.w = function(t3, e3) {
    ...
    var _2 = function() {
      ...
      return m3.parse = function(t3) {
        ...
        var n3 = this, r3 = !!O2.u(e3) || e3, h3 = O2.p(t3), l2 = function(t4, e4) {
        ...
        var n3, o3 = O2.p(t3), h3 = "set" + (this.$u ? "UTC" : ""), l2 = (n3 = {}, n3[a2] = h3 + "Date", n3[d] = h3 + "Date", n3[f2] = h3 + "Month", n3[c2] = h3 + "FullYear", n3[u2] = h3 + "Hours", n3[s2] = h3 + "Minutes", n3[i] = h3 + "Seconds", n3[r2] = h3 + "Milliseconds", n3)[o3], $3 = o3 === a2 ? this.$D + (e3 - this.$W) : e3;
        if (o3 === f2 || o3 === c2) {
        ...
        if ($3 === o2)
          return y3(7);
        var M3 = (d2 = {}, d2[s2] = e2, d2[u2] = n2, d2[i] = t2, d2)[$3] || 1, m4 = this.$d.getTime() + r3 * M3;
        return O2.w(m4, this);
        ...
        var r3 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i2 = O2.z(this), s3 = this.$H, u3 = this.$m, a3 = this.$M, o3 = n3.weekdays, f3 = n3.months, h3 = function(t4, n4, i3, s4) {
        ...
        }, $3 = { YY: String(this.$y).slice(-2), YYYY: this.$y, M: a3 + 1, MM: O2.s(a3 + 1, 2, "0"), MMM: h3(n3.monthsShort, a3, f3, 3), MMMM: h3(f3, a3), D: this.$D, DD: O2.s(this.$D, 2, "0"), d: String(this.$W), dd: h3(n3.weekdaysMin, this.$W, o3, 2), ddd: h3(n3.weekdaysShort, this.$W, o3, 3), dddd: o3[this.$W], H: String(s3), HH: O2.s(s3, 2, "0"), h: c3(1), hh: c3(2), a: d2(s3, u3, true), A: d2(s3, u3, false), m: String(u3), mm: O2.s(u3, 2, "0"), s: String(this.$s), ss: O2.s(this.$s, 2, "0"), SSS: O2.s(this.$ms, 3, "0"), Z: i2 };
        return r3.replace(y2, function(t4, e4) {
          return e4 || $3[t4] || i2.replace(":", "");
        });
      }, m3.utcOffset = function() {
        return 15 * -Math.round(this.$d.getTimezoneOffset() / 15);
      }, m3.diff = function(r3, d2, l2) {
        var $3, y3 = O2.p(d2), M3 = w2(r3), m4 = (M3.utcOffset() - this.utcOffset()) * e2, v3 = this - M3, g3 = O2.m(this, M3);
        return g3 = ($3 = {}, $3[c2] = g3 / 12, $3[f2] = g3, $3[h2] = g3 / 3, $3[o2] = (v3 - m4) / 6048e5, $3[a2] = (v3 - m4) / 864e5, $3[u2] = v3 / n2, $3[s2] = v3 / e2, $3[i] = v3 / t2, $3)[y3] || v3, l2 ? g3 : O2.a(g3);
    ...
    return w2.prototype = T2, [["$ms", r2], ["$s", i], ["$m", s2], ["$H", u2], ["$W", a2], ["$M", f2], ["$y", c2], ["$D", d]].forEach(function(t3) {
      T2[t3[1]] = function(e3) {
...
function useAddDevice(appId2) {
  ...
  function addDevice() {
    return __async(this, null, function* () {
      ...
      try {
        const passageUser = new Y(appId2).getCurrentUser();
        return yield passageUser.addDevice();
      } catch (e2) {
...
function useAppInfo(appId2) {
  const activeAppId = appId2 === void 0 ? useAppId().appId : ref(appId2);
  ...
  function execute() {
    return __async(this, null, function* () {
      ...
      const passage = new Y(activeAppId.value);
      try {
    ...
    return function() {
      ...
      var Iti = function() {
        ...
        _createClass(Iti2, [{
          ...
          value: function _countryNameSort(a2, b) {
          ...
          key: "_startsWith",
          value: function _startsWith(a2, b) {
            return a2.substr(0, b.length).toLowerCase() === b;
          }
        }, {
          ...
          value: function _updateValFromNumber(originalNumber) {
            ...
            if (this.options.formatOnDisplay && window.intlTelInputUtils && this.selectedCountryData) {
              ...
              number2 = intlTelInputUtils.formatNumber(number2, this.selectedCountryData.iso2, format);
            }
...
var Utils = class {
  ...
  static isIntercepted(a2, b) {
    return !(a2.y >= b.y + b.h || a2.y + a2.h <= b.y || a2.x + a2.w <= b.x || a2.x >= b.x + b.w);
  }
  static isTouching(a2, b) {
    return Utils.isIntercepted(a2, { x: b.x - 0.5, y: b.y - 0.5, w: b.w + 1, h: b.h + 1 });
  }
  static sort(nodes, dir, column) {
    column = column || nodes.reduce((col, n2) => Math.max(n2.x + n2.w, col), 0) || 12;
    if (dir === -1)
      return nodes.sort((a2, b) => b.x + b.y * column - (a2.x + a2.y * column));
    else
      return nodes.sort((b, a2) => b.x + b.y * column - (a2.x + a2.y * column));
  }
  ...
  static copyPos(a2, b, minMax = false) {
    a2.x = b.x;
    a2.y = b.y;
    a2.w = b.w;
    a2.h = b.h;
  ...
  static samePos(a2, b) {
    return a2 && b && a2.x === b.x && a2.y === b.y && a2.w === b.w && a2.h === b.h;
  }
  static removeInternalAndSame(a2, b) {
...
var GridStackEngine = class {
  ...
  swap(a2, b) {
    ...
    function _doSwap() {
      ...
      a2._dirty = b._dirty = true;
      return true;
    }
    let touching;
    if (a2.w === b.w && a2.h === b.h && (a2.x === b.x || a2.y === b.y) && (touching = utils_1.Utils.isTouching(a2, b)))
      return _doSwap();
    if (touching === false)
      return;
    if (a2.w === b.w && a2.x === b.x && (touching || (touching = utils_1.Utils.isTouching(a2, b)))) {
      if (b.y < a2.y) {
        let t2 = a2;
        a2 = b;
        b = t2;
    ...
    if (touching === false)
      return;
    if (a2.h === b.h && a2.y === b.y && (touching || (touching = utils_1.Utils.isTouching(a2, b)))) {
      if (b.x < a2.x) {
        let t2 = a2;
        a2 = b;
        b = t2;
  ...
  moveNodeCheck(node, o2) {
    ...
    clone.nodes.filter((n2) => n2._dirty).forEach((c2) => {
      let n2 = this.nodes.find((a2) => a2._id === c2._id);
      if (!n2)
        return;
  ...
  updateNodeWidths(prevColumn, column, nodes, layout = "moveScale") {
    ...
    cacheNodes.forEach((cacheNode) => {
      let j = nodes.findIndex((n2) => n2._id === cacheNode._id);
      if (j !== -1) {
  ...
  cacheLayout(nodes, column, clear2 = false) {
    let copy = [];
    nodes.forEach((n2, i) => {
      n2._id = n2._id || GridStackEngine._idSeq++;
  ...
  class GridStack {
    constructor(el, opts = {}) {
      ...
      if (this.opts.auto) {
        ...
        elements.sort((a2, b) => a2.i - b.i).forEach((e2) => this._prepareElement(e2.el));
        this.commit();
      }
    ...
    update(els, opt) {
      if (arguments.length > 2) {
        ...
        let a2 = arguments, i = 1;
        opt = { x: a2[i++], y: a2[i++], w: a2[i++], h: a2[i++] };
    ...
    willItFit(node) {
      if (arguments.length > 1) {
        ...
        let a2 = arguments, i = 0, w2 = { x: a2[i++], y: a2[i++], w: a2[i++], h: a2[i++], autoPosition: a2[i++] };
...
var _hoisted_1 = ["id", "gs-id", "gs-x", "gs-y", "gs-w", "gs-h"];
var _hoisted_2 = { class: "grid-stack-item-content" };
...
var UserMetadata = _export_sfc(_sfc_main, [["render", _sfc_render]]);
...
var _hoisted_1$q = { class: "identifier-form" };
var _hoisted_2$h = { class: "has-text-centered" };
var _hoisted_3$f = createBaseVNode("br", null, null, -1);
var _hoisted_4$e = ["onSubmit"];
var _hoisted_5$d = ["autocomplete", "inputmode", "placeholder", "onInput"];
var _hoisted_6$b = { class: "flex-row flex-center" };
var _hoisted_7$b = ["onClick"];
var _hoisted_8$8 = {
  key: 0,
  ...
  setup(__props, { emit: emit2 }) {
    ...
    function validateInput() {
      if (formattedIdentifier() === "") {
        ...
        return false;
      } else if (props.identifierMode === oe.email && !isEmail2()) {
        ...
        return false;
      } else if (props.identifierMode === oe.both && !isPhoneNumber() && !isEmail2()) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$q, [
        withDirectives(createBaseVNode("div", _hoisted_2$h, [
          ...
          _hoisted_3$f,
          createBaseVNode("strong", null, toDisplayString$1(identifierText.value), 1)
        ], 512), [
        ...
        createBaseVNode("div", _hoisted_6$b, [
          ...
          }, toDisplayString$1(unref(t2)("continue")), 9, _hoisted_7$b)
        ]),
        showWelcomeUI.value ? (openBlock(), createElementBlock("div", _hoisted_8$8, [
          ...
          }, toDisplayString$1(unref(t2)("switch-account")), 9, _hoisted_9$7)
...
function storeLastLogin(identiferOrUserInfo) {
  return __async2(this, null, function* () {
    ...
    if (identiferOrUserInfo === void 0) {
      ...
      const passage = new Y(appId2.value);
  ...
  setup(__props, { emit: emit2 }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        ...
        !publicSignup.value ? (openBlock(), createElementBlock("div", _hoisted_1$p, toDisplayString$1(unref(t2)("public-registration-not-allowed")), 1)) : createCommentVNode("", true)
      ]);
    };
  }
});
var ephemeralAppIdKey = "psg_ephemeral_app_id";
var ephemeralAppNameKey = "psg_ephemeral_app_name";
var EphemeralAppService = class {
  newEphemeralApp() {
    return __async2(this, null, function* () {
...
var _sfc_main$r = defineComponent({
  ...
  setup() {
    ...
    const passageWebSetup = () => __async2(this, null, function* () {
    ...
    const checkIfClaimed = () => __async2(this, null, function* () {
      const { appId: appId2 } = useAppId();
    ...
    onBeforeMount(() => __async2(this, null, function* () {
...
var _hoisted_4$d = { key: 0 };
var _hoisted_5$c = ["href"];
var _hoisted_6$a = { key: 1 };
var _hoisted_7$a = createBaseVNode("br", null, null, -1);
function _sfc_render$12(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.isEphemeral ? (openBlock(), createElementBlock("div", _hoisted_1$o, [
    _ctx.error ? (openBlock(), createElementBlock("div", _hoisted_2$g, toDisplayString$1(_ctx.t("unable-to-create-test-app")), 1)) : (openBlock(), createElementBlock("div", _hoisted_3$e, [
      !_ctx.claimed ? (openBlock(), createElementBlock("div", _hoisted_4$d, [
        createTextVNode(toDisplayString$1(_ctx.t("currently-using-test-app")) + " ", 1),
        createBaseVNode("a", {
          href: _ctx.ephemeralClaimUrl,
          target: "_blank"
        }, toDisplayString$1(_ctx.t("click-here")), 9, _hoisted_5$c),
        createTextVNode(".")
      ])) : (openBlock(), createElementBlock("div", _hoisted_6$a, [
        createTextVNode(toDisplayString$1(_ctx.t("add-your-claimed-app-like-this")) + " ", 1),
        _hoisted_7$a,
        createTextVNode(toDisplayString$1(_ctx.exampleTag), 1)
      ]))
    ]))
  ])) : createCommentVNode("", true);
}
var EphemeralAppInfo = _export_sfc(_sfc_main$r, [["render", _sfc_render$12]]);
var _hoisted_1$n = {
  key: 0,
  class: "link has-text-centered"
};
var _hoisted_2$f = { class: "passage-branding" };
var _hoisted_3$d = {
...
var _hoisted_1$m = { class: "view-email-input" };
var _hoisted_2$e = { class: "auth-flex-container" };
var _hoisted_3$c = { class: "title main-title has-text-centered" };
var _hoisted_4$c = createBaseVNode("div", { style: { "height": "20px" } }, null, -1);
var _hoisted_5$b = { class: "spacer" };
var _hoisted_6$9 = { class: "link has-text-centered" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$m, [
        createBaseVNode("div", _hoisted_2$e, [
          createBaseVNode("div", _hoisted_3$c, toDisplayString$1(showLogin.value ? unref(t2)("login-title") : unref(t2)("register-title")), 1),
          _hoisted_4$c,
          ...
          createBaseVNode("div", _hoisted_6$9, [
            showLogin.value && publicSignup.value ? (openBlock(), createElementBlock("div", _hoisted_7$9, [
              ...
              createBaseVNode("a", {
                ...
                role: "button",
                "data-test": "register-link"
              }, toDisplayString$1(unref(t2)("register-here")), 9, _hoisted_8$7)
              ...
              }, toDisplayString$1(unref(t2)("login-here")), 9, _hoisted_10$4)
            ])) : createCommentVNode("", true)
          ])
        ]),
...
var _hoisted_1$l = { class: "auth-flex-container" };
var _hoisted_2$d = { class: "image has-text-centered" };
var _hoisted_3$b = {
  class: "content has-text-centered",
  "data-test": "activate-magic-link-message"
};
var _hoisted_4$b = { key: 0 };
var _hoisted_5$a = { key: 1 };
var _hoisted_6$8 = { key: 2 };
var _hoisted_7$8 = { key: 3 };
var _hoisted_8$6 = { key: 4 };
var _hoisted_9$5 = {
  key: 0,
  class: "flex-row flex-center",
  style: { "padding": "20px 0px" }
};
var _hoisted_10$3 = ["onClick", "disabled"];
var _hoisted_11$3 = { key: 0 };
var _hoisted_12$3 = { key: 1 };
var _hoisted_13$3 = { key: 2 };
        ...
        default: withCtx(() => [
          withDirectives(createBaseVNode("div", _hoisted_1$l, [
            ...
            createBaseVNode("div", _hoisted_3$b, [
              unref(showSuccess) && unref(magicLinkAction) === unref(MagicLinkActionEnum).LOGIN ? (openBlock(), createElementBlock("div", _hoisted_4$b, toDisplayString$1(unref(t2)("successfully-logged-in-redirect")), 1)) : unref(showSuccess) && unref(magicLinkAction) === unref(MagicLinkActionEnum).VERIFY ? (openBlock(), createElementBlock("div", _hoisted_5$a, toDisplayString$1(unref(t2)("successfully-changed-email")), 1)) : unref(showFailure) && unref(invalidMagicLink) && unref(magicLinkAction) === unref(MagicLinkActionEnum).VERIFY ? (openBlock(), createElementBlock("div", _hoisted_6$8, toDisplayString$1(unref(t2)("link-invalid")), 1)) : unref(showFailure) && unref(invalidMagicLink) ? (openBlock(), createElementBlock("div", _hoisted_7$8, toDisplayString$1(unref(t2)("login-link-invalid")), 1)) : unref(showFailure) && unref(magicLinkAction) === unref(MagicLinkActionEnum).VERIFY ? (openBlock(), createElementBlock("div", _hoisted_8$6, toDisplayString$1(unref(t2)("verification-failed-please-try-again")), 1)) : createCommentVNode("", true)
            ]),
            unref(showFailure) || unref(showSuccess) ? (openBlock(), createElementBlock("div", _hoisted_9$5, [
              createBaseVNode("button", {
                ...
                unref(showFailure) && unref(invalidMagicLink) ? (openBlock(), createElementBlock("span", _hoisted_11$3, toDisplayString$1(unref(t2)("request-new-link")), 1)) : unref(showFailure) ? (openBlock(), createElementBlock("span", _hoisted_12$3, toDisplayString$1(unref(t2)("try-again")), 1)) : unref(showSuccess) ? (openBlock(), createElementBlock("span", _hoisted_13$3, toDisplayString$1(unref(t2)("redirect-now")), 1)) : createCommentVNode("", true)
              ], 10, _hoisted_10$3)
            ])) : createCommentVNode("", true)
          ], 512), [
...
var _hoisted_1$k = { class: "view-verify-token" };
...
var _hoisted_1$j = { class: "view-email-input" };
...
var _hoisted_1$i = { class: "view-email-input" };
...
var _hoisted_1$h = { class: "spinner-box" };
var _hoisted_2$c = { class: "spinner-content" };
...
var Spinner = _export_sfc(_sfc_main$k, [["render", _sfc_render2]]);
var _hoisted_1$g = { class: "auth-flex-container" };
var _hoisted_2$b = { class: "title has-text-centered" };
var _hoisted_3$a = {
  key: 0,
  class: "content has-text-centered",
...
var _hoisted_5$9 = { class: "flex-row flex-center" };
var _hoisted_6$7 = ["onClick", "disabled"];
var _hoisted_7$7 = createBaseVNode("div", { class: "spacer" }, null, -1);
var _hoisted_8$5 = { class: "link has-text-centered" };
var _hoisted_9$4 = ["onClick"];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$g, [
        ...
        createBaseVNode("div", _hoisted_5$9, [
          ...
          }, toDisplayString$1(unref(t2)("resend-isemail-email-message", [isEmail2.value ? unref(t2)("email") : unref(t2)("message")])), 9, _hoisted_6$7)
        ]),
        _hoisted_7$7,
        createBaseVNode("div", _hoisted_8$5, [
          ...
          }, toDisplayString$1(unref(t2)("change-isemail-email-phone", [isEmail2.value ? unref(t2)("email") : unref(t2)("phone")])), 9, _hoisted_9$4)
        ])
      ]);
    };
  }
});
var _hoisted_1$f = { class: "view-access-token" };
...
var _hoisted_1$e = { class: "passage-learnmore-modal" };
var _hoisted_2$a = { class: "passage-learnmore-top" };
var _hoisted_3$9 = { class: "passage-learnmore-close-button" };
var _hoisted_4$9 = { class: "passage-learnmore-content" };
var _hoisted_5$8 = { style: { "margin-bottom": "32px" } };
          ...
          createBaseVNode("div", _hoisted_1$e, [
            createBaseVNode("div", _hoisted_2$a, [
              createBaseVNode("div", {
                ...
                createBaseVNode("span", _hoisted_3$9, toDisplayString$1(unref(t2)("close")), 1),
                createVNode(unref(InlineSvg), {
...
var _hoisted_1$d = { style: { "margin-bottom": "12px" } };
var _hoisted_2$9 = { class: "passage-learnmore-header" };
var _hoisted_3$8 = { class: "passage-learnmore-body" };
var _hoisted_4$8 = { class: "passage-learnmore-header" };
var _hoisted_5$7 = { class: "passage-learnmore-body" };
var _hoisted_6$6 = { class: "passage-learnmore-header" };
var _hoisted_7$6 = { class: "passage-learnmore-body" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$h, null, {
        cta: withCtx(() => [
          createBaseVNode("div", _hoisted_1$d, toDisplayString$1(unref(t2)("passkeys-are-a-simple")), 1),
        ...
        body: withCtx(() => [
          ...
          createBaseVNode("div", _hoisted_3$8, toDisplayString$1(unref(t2)("unlock-your-passkey")), 1),
          ...
          createBaseVNode("div", _hoisted_5$7, toDisplayString$1(unref(t2)("passkey-is-unique")), 1),
          ...
          createBaseVNode("div", _hoisted_7$6, toDisplayString$1(unref(t2)("easy-to-use")), 1)
        ]),
        _: 1
      });
    };
...
var _hoisted_2$8 = { class: "title secondary-title has-text-centered" };
var _hoisted_3$7 = { class: "image has-text-centered" };
var _hoisted_4$7 = { key: 0 };
var _hoisted_5$6 = {
  key: 2,
  class: "flex-row flex-center"
};
var _hoisted_6$5 = ["onClick", "disabled"];
var _hoisted_7$5 = ["onClick", "disabled"];
var _hoisted_8$4 = {
  key: 3,
  class: "flex-row flex-center"
};
var _hoisted_9$3 = ["onClick", "disabled"];
var _hoisted_10$2 = createBaseVNode("div", { class: "spacer" }, null, -1);
var _hoisted_11$2 = {
  key: 4,
  class: "content has-text-centered",
  style: { "margin-top": "20px !important" }
};
var _hoisted_12$2 = { class: "link" };
var _hoisted_13$2 = ["onClick"];
var _hoisted_14$2 = { class: "link" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$c, [
        createBaseVNode("div", _hoisted_2$8, toDisplayString$1(unref(t2)("register-with-a-passkey")), 1),
        ...
        showFailure.value ? (openBlock(), createElementBlock("div", _hoisted_5$6, [
          ...
          }, toDisplayString$1(unref(t2)("try-again")), 9, _hoisted_6$5),
          _ctx.appInfo.auth_fallback_method !== unref(ue).None ? (openBlock(), createElementBlock("button", {
            ...
            ref_key: "autofocusButton",
            ref: autofocusButton
          }, toDisplayString$1(fallbackSendCodeEmailOrTextBtnCopy.value), 9, _hoisted_7$5)) : createCommentVNode("", true)
          ...
          createBaseVNode("button", {
            ...
            createBaseVNode("span", null, toDisplayString$1(unref(t2)("register-with-passkey")), 1)
          ], 10, _hoisted_9$3)
        ])),
        _hoisted_10$2,
        showFailure.value ? (openBlock(), createElementBlock("div", _hoisted_11$2, [
          createBaseVNode("div", _hoisted_12$2, [
            createBaseVNode("a", {
              ...
              role: "button",
              "data-test": "change-email-button"
            }, toDisplayString$1(unref(t2)("change-isemail-email-phone", [isEmail2.value ? unref(t2)("email") : unref(t2)("phone")])), 9, _hoisted_13$2)
          ])
        ])) : createCommentVNode("", true),
        !showFailure.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_14$2, [
            createBaseVNode("a", {
              ...
              role: "button",
              "data-test": "change-email-button"
            }, toDisplayString$1(unref(t2)("back")), 9, _hoisted_15$2)
          ]),
          supportsFallback.value ? (openBlock(), createElementBlock("div", _hoisted_16$2, [
            ...
            }, toDisplayString$1(fallbackRegisterWithCodeEmailOrTextBtnCopy.value), 9, _hoisted_17)
          ])) : createCommentVNode("", true)
...
var _hoisted_1$b = { class: "auth-flex-container" };
var _hoisted_2$7 = { class: "title has-text-centered" };
var _hoisted_3$6 = {
...
var _hoisted_5$5 = { "data-test": "failure-message" };
var _hoisted_6$4 = {
  key: 2,
  class: "flex-row flex-center"
};
var _hoisted_7$4 = ["onClick", "disabled"];
var _hoisted_8$3 = ["onClick", "disabled"];
var _hoisted_9$2 = createBaseVNode("div", { class: "spacer" }, null, -1);
var _hoisted_10$1 = {
  key: 3,
  class: "content has-text-centered",
  style: { "margin-top": "20px !important" }
};
var _hoisted_11$1 = { class: "link" };
var _hoisted_12$1 = ["onClick"];
var _hoisted_13$1 = { class: "link" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$b, [
        createBaseVNode("div", _hoisted_2$7, toDisplayString$1(unref(t2)("log-in-with-a-passkey")), 1),
        ...
        showFailure.value ? (openBlock(), createElementBlock("div", _hoisted_6$4, [
          createBaseVNode("button", {
            ...
            disabled: loading.value,
            style: { "margin-right": "5px" }
          }, toDisplayString$1(unref(t2)("try-again")), 9, _hoisted_7$4),
          _ctx.appInfo.auth_fallback_method !== unref(ue).None ? (openBlock(), createElementBlock("button", {
            key: 0,
            ...
            ref_key: "autofocusButton",
            ref: autofocusButton
          }, toDisplayString$1(fallbackSendCodeEmailOrTextBtnCopy.value), 9, _hoisted_8$3)) : createCommentVNode("", true)
        ])) : createCommentVNode("", true),
        _hoisted_9$2,
        showFailure.value ? (openBlock(), createElementBlock("div", _hoisted_10$1, [
          createBaseVNode("div", _hoisted_11$1, [
            createBaseVNode("a", {
              ...
              role: "button",
              "data-test": "change-email-button"
            }, toDisplayString$1(unref(t2)("change-isemail-email-phone", [isEmail2.value ? unref(t2)("email") : unref(t2)("phone")])), 9, _hoisted_12$1)
          ])
        ])) : createCommentVNode("", true),
        !showFailure.value ? (openBlock(), createElementBlock("div", {
          key: 4,
          ...
          createBaseVNode("div", _hoisted_13$1, [
            createBaseVNode("a", {
              ...
              role: "button",
              "data-test": "change-email-button"
            }, toDisplayString$1(unref(t2)("back")), 9, _hoisted_14$1)
          ]),
          supportsFallback.value ? (openBlock(), createElementBlock("div", _hoisted_15$1, [
            createBaseVNode("a", {
              ...
              role: "button",
              "data-test": "register-email-button"
            }, toDisplayString$1(loginWithCodeEmailOrTextBtnCopy.value), 9, _hoisted_16$1)
          ])) : createCommentVNode("", true)
        ], 2)) : createCommentVNode("", true)
      ]);
    };
...
var _hoisted_1$a = { class: "view-webauthn-sign-in" };
...
var _hoisted_2$62 = ["data-test", "type", "inputtype", "placeholder", "inputmode", "disabled", "maxlength", "autocomplete"];
  ...
  setup(__props, { emit: emit2 }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$9, [
        ...
        }, null, 42, _hoisted_2$62), [
          [vModelDynamic, model.value]
        ]),
        !_ctx.isLastChild && _ctx.separator ? (openBlock(), createElementBlock("span", _hoisted_3$52, [
  ...
  setup(__props, { emit: emit2 }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$8, [
        _ctx.inputType === "password" ? (openBlock(), createElementBlock("input", _hoisted_2$52)) : createCommentVNode("", true),
...
var _hoisted_1$72 = { class: "auth-flex-container" };
var _hoisted_2$42 = { class: "title has-text-centered" };
var _hoisted_3$42 = { class: "content wrap-text" };
var _hoisted_4$42 = { style: { "margin-top": "32px", "margin-bottom": "40px" } };
var _hoisted_5$42 = ["innerHTML"];
var _hoisted_6$3 = { class: "flex flex-row flex-center" };
var _hoisted_7$3 = {
  class: "flex-row",
...
var _hoisted_11 = createBaseVNode("div", { class: "spacer" }, null, -1);
var _hoisted_12 = { class: "flex-row flex-wrap flex-between" };
var _hoisted_13 = { class: "link" };
var _hoisted_14 = ["onClick"];
var _hoisted_15 = { class: "link" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$72, [
        createBaseVNode("form", null, [
          ...
          createBaseVNode("div", _hoisted_3$42, [
            createBaseVNode("div", _hoisted_4$42, [
              createBaseVNode("p", { innerHTML: message.value }, null, 8, _hoisted_5$42)
            ])
          ]),
          ...
          createBaseVNode("div", _hoisted_7$3, [
            createBaseVNode("div", _hoisted_8$2, toDisplayString$1(errorMessage.value ? errorMessage.value : " "), 1)
          ]),
          createBaseVNode("div", _hoisted_9$1, [
            ...
            }, toDisplayString$1(unref(t2)("continue")), 9, _hoisted_10)
          ]),
          _hoisted_11,
          createBaseVNode("div", _hoisted_12, [
            createBaseVNode("div", _hoisted_13, [
              ...
              }, toDisplayString$1(btnGoBackText.value), 9, _hoisted_14)
            ]),
            createBaseVNode("div", _hoisted_15, [
              ...
              }, toDisplayString$1(btnResendText.value), 9, _hoisted_16)
            ])
          ])
        ])
      ]);
...
var _hoisted_1$62 = { class: "view-access-token" };
...
var _hoisted_1$52 = { class: "image has-text-centered" };
var _hoisted_2$32 = { key: 0 };
var _hoisted_3$32 = {
  class: "flex-row flex-center",
  style: { "padding": "20px 0px" }
};
var _hoisted_4$32 = ["onClick", "disabled"];
var _hoisted_5$32 = { key: 0 };
var _hoisted_6$2 = { key: 1 };
var _hoisted_7$2 = {
  key: 2,
  class: "link has-text-centered"
};
...
var _sfc_main$72 = defineComponent({
  ...
  setup(__props) {
    ...
    const showSuccess = ref(false);
    const newDevice = ref();
    const { addDevice, addPending } = useAddDevice(appId2.value);
    const { autofocusButton } = useAutofocusButton();
    const title = computed(() => {
      if (showFailure.value) {
        return t2("something-went-wrong");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", {
          ...
          "data-test": "activate-magic-link-message"
        }, toDisplayString$1(title.value), 3),
        createBaseVNode("figure", _hoisted_1$52, [
        ...
        showFailure.value ? (openBlock(), createElementBlock("div", _hoisted_2$32, toDisplayString$1(unref(t2)("failed-to-add-this-device")), 1)) : (openBlock(), createBlock(_sfc_main$g, {
          key: 1,
          cta: unref(t2)("log-into-your-account")
        }, null, 8, ["cta"])),
        createBaseVNode("div", _hoisted_3$32, [
          createBaseVNode("button", {
            onClick: withModifiers(onButtonClick, ["prevent"]),
            type: "button",
            ...
            showFailure.value ? (openBlock(), createElementBlock("span", _hoisted_5$32, toDisplayString$1(unref(t2)("try-again")), 1)) : (openBlock(), createElementBlock("span", _hoisted_6$2, toDisplayString$1(unref(t2)("add-passkey")), 1))
          ], 10, _hoisted_4$32)
        ]),
        !showSuccess.value ? (openBlock(), createElementBlock("div", _hoisted_7$2, [
          createBaseVNode("div", null, [
            ...
            }, toDisplayString$1(unref(t2)("skip")), 9, _hoisted_8$1)
          ])
        ])) : createCommentVNode("", true)
      ], 64);
    };
...
var _hoisted_1$42 = { class: "view-add-device" };
...
var _hoisted_2$22 = { class: "passage-learnmore-header" };
var _hoisted_3$22 = { class: "passage-learnmore-body" };
var _hoisted_4$22 = { class: "passage-learnmore-header" };
var _hoisted_5$22 = { class: "passage-learnmore-body" };
var _sfc_main$52 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$h, null, {
        cta: withCtx(() => [
          createBaseVNode("div", _hoisted_1$32, toDisplayString$1(unref(t2)("passkeys-are-required")) + toDisplayString$1(" "), 1),
          createTextVNode(" " + toDisplayString$1(unref(t2)("try-again-on-device-with-passkeys")), 1)
        ]),
        body: withCtx(() => [
          createBaseVNode("div", _hoisted_2$22, toDisplayString$1(unref(t2)("what-are-passkeys")), 1),
          createBaseVNode("div", _hoisted_3$22, toDisplayString$1(unref(t2)("passkeys-are-a-simpler-and-more-secure-alternative")), 1),
          createBaseVNode("div", _hoisted_4$22, toDisplayString$1(unref(t2)("devices-that-support-passkeys")), 1),
          createBaseVNode("div", _hoisted_5$22, toDisplayString$1(unref(t2)("devices-with-a-biometric-sensor-are-likely-to-support-passkeys")), 1)
        ]),
        _: 1
      });
    };
...
var _hoisted_1$22 = { class: "auth-flex-container" };
var _hoisted_2$12 = { class: "title has-text-centered" };
var _hoisted_3$12 = {
  class: "image has-text-centered",
  style: { "margin": "5px auto" }
};
var _hoisted_4$12 = createBaseVNode("div", { class: "spacer" }, null, -1);
var _hoisted_5$12 = { class: "flex-row flex-wrap flex-center" };
var _hoisted_6$1 = { class: "link" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$22, [
        createBaseVNode("div", _hoisted_2$12, toDisplayString$1(unref(t2)("device-not-supported")), 1),
        createBaseVNode("figure", _hoisted_3$12, [
          createVNode(unref(InlineSvg), {
        ...
        _hoisted_4$12,
        createBaseVNode("div", _hoisted_5$12, [
          createBaseVNode("div", _hoisted_6$1, [
            createBaseVNode("a", {
              onClick: withModifiers(changeEmail, ["prevent"]),
              role: "button",
              "data-test": "change-email-button"
            }, toDisplayString$1(unref(t2)("back")), 9, _hoisted_7$1)
          ])
        ])
      ]);
    };
...
var _hoisted_1$12 = { class: "auth-flex-container" };
var _hoisted_22 = { class: "title has-text-centered" };
var _hoisted_32 = {
  class: "image has-text-centered",
  style: { "margin": "5px auto" }
};
...
var _hoisted_52 = { class: "wrap-text" };
var _hoisted_62 = createBaseVNode("div", { class: "spacer" }, null, -1);
var _hoisted_7 = { class: "flex-row flex-wrap flex-center" };
var _hoisted_8 = { class: "link" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$12, [
        createBaseVNode("div", _hoisted_22, toDisplayString$1(unref(t2)("login-not-supported")), 1),
        createBaseVNode("figure", _hoisted_32, [
          createVNode(unref(InlineSvg), {
            src: unref(Icons).passkeyArrow,
            alt: "Device not supported",
            style: { "margin": "5px" }
        ...
        createBaseVNode("div", _hoisted_42, toDisplayString$1(unref(t2)("passkeys-are-now-required")), 1),
        createBaseVNode("div", _hoisted_52, toDisplayString$1(unref(t2)("please-contact-support-to-regain-access")), 1),
        _hoisted_62,
        createBaseVNode("div", _hoisted_7, [
          createBaseVNode("div", _hoisted_8, [
            createBaseVNode("a", {
              ...
              role: "button",
              "data-test": "change-email-button"
            }, toDisplayString$1(unref(t2)("back")), 9, _hoisted_9)
          ])
        ])
      ]);
    };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        unref(invalidAppId) ? (openBlock(), createElementBlock("div", _hoisted_18, toDisplayString$1(unref(t2)("invalid-app-id")), 1)) : createCommentVNode("", true)
      ], 64);
    };
  }
});
...
var _hoisted_19 = { class: "container" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        withDirectives(createBaseVNode("div", _hoisted_19, [
          (openBlock(), createBlock(_sfc_main2, {
            key: _ctx.appId,
...
function registerPassageAuthElement() {
  safelyRegisterElement(_sfc_main3, "auth");
}
